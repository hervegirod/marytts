...
public class Mary {
   ...
   public static void startup(boolean addJarsToClasspath) throws Exception {
      ...
      try {
         Class<? extends Object> xercesVersion = LoaderConfig.getClass("org.apache.xerces.impl.Version");
   ...
   public static void main(final String[] args) throws Exception {
      ...
      if (server.equals("socket")) { // socket server mode
         main = (Runnable) LoaderConfig.newInstance("marytts.server.MaryServer");
      } else if (server.equals("http")) { // http server mode
         main = (Runnable) LoaderConfig.newInstance("marytts.server.http.MaryHttpServer");
